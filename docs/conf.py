...
# This allows modules to be indexed under the submodule name rather than all appearing under                                 a least squares sphere fitting algorithm,
...
# The short X.Y version.
# version =                                 a least squares sphere fitting algorithm,.__version__
# The full version, including alpha/beta/rc tags.
# release =                                 a least squares sphere fitting algorithm,.__version__
